  ...
  return(
    <div>
      ...
      <div style={{marginTop:'100px'}}>
          <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical" style={{width:"10%",float:"left",backgroundColor:"#343a40",border:"0.5px solid white",padding:'5px'}}>
