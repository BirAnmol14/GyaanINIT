...
function PostPage(props){
  return (
      ...
      <h1 className="post"><center>{props.body.title}<br/><h5>{props.category&&props.category.name?<a className="post-category post-category-js" href={props.category?"/group/"+props.category.slug+'/'+props.category.id:'#'} id='cat' name={props.body.category_id}>{props.category.name}</a>:null}
      </h5>
      </center>
      </h1>
      {
